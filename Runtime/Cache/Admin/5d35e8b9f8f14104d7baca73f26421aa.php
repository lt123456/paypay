...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="method" value="<?php echo ((isset($info["method"]) && ($info["method"] !== ""))?($info["method"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
		...
		<?php
 $field = explode(',',$info['field']); $config = unserialize($info['config']); ?>
		<?php if(is_array($field)): $i = 0; $__LIST__ = $field;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $l = explode(':',$vo)['0']; $r = explode(':',$vo)['1']; ?>
		<div class="form-item">
			<label class="item-label"><?php echo ($l); ?><span class="check-tips"></span></label>
			<div class="controls">
				<textarea   style="width:60%;height:200px;" name="config[<?php echo ($r); ?>]"><?php echo ($config[$r]); ?></textarea>
			</div>
		...
		<div class="form-item">
			...
			<div class="controls">
				开启 <input name="status" type="radio"  value="Y" <?php if($info["status"] == Y): ?>checked<?php endif; ?>>
				关闭 <input name="status" type="radio"  value="N" <?php if($info["status"] == N): ?>checked<?php endif; ?>>
			</div>
		</div>
		<div class="form-item">
		...
		<div class="form-item">
			...
			<div class="controls">
				<label class="textarea input-large">
					<input type="text" class="text input-large" name="domain" value="<?php echo ((isset($info["domain"]) && ($info["domain"] !== ""))?($info["domain"]):''); ?>">
				</label>
			</div>
		</div>
		<div class="form-item">
			...
			<div class="controls">
				<label class="textarea input-large">
					<input type="text" class="text input-large" name="shop_url" value="<?php echo ((isset($info["shop_url"]) && ($info["shop_url"] !== ""))?($info["shop_url"]):''); ?>">
				</label>
			</div>
		</div>
