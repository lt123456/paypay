...
<!-- saved from url=(0076)http://zf.226600zfb.com/index.php/Lefu/tijiao/order_no/9061493544769662.html -->
...
<div class="page_main" style="background:#FFF; border-bottom:1px solid #DDD;">
     ...
     如有疑问请将订单发送给<a href="<?php echo C('CALL_KF_URL');?>" target="_blank" style="color:#2196F3;">在线客服</a>! 返回<a href="<?php echo C('WEB_URL');?>" style="font-size: 25px;text-decoration: none; color: blue;">充值中心</a>
