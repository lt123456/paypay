...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <style type="text/css">
    ...
    {display:inline-block;width:41px;height:36px;background:url("/Public/Home/images/pc/alipay.jpg") 0 -115px no-repeat;vertical-align:middle;margin-right:7px}
    .mod-title .text
    ...
    .mod-ct .detail .arrow .ico-arrow
    {display:inline-block;width:20px;height:11px;background:url("/Public/Home/images/pc/alipay.jpg") -25px -100px no-repeat}
    .mod-ct .detail-open .arrow .ico-arrow
    {display:inline-block;width:20px;height:11px;background:url("/Public/Home/images/pc/alipay.jpg") 0 -100px no-repeat}
    .mod-ct .detail-open .detail-ct
    {display:block}
    .mod-ct .tip
    {margin-top:40px;border-top:1px dashed #e5e5e5;padding:30px 0;position:relative}
    .mod-ct .tip .ico-scan
    {display:inline-block;width:56px;height:55px;background:url("/Public/Home/images/pc/alipay.jpg") 0 0 no-repeat;vertical-align:middle;*display:inline;*zoom:1}
    .mod-ct .tip .tip-text
    ...
    .mod-ct .tip .dec
    {display:inline-block;width:22px;height:45px;background:url("/Public/Home/images/pc/alipay.jpg") 0 -55px no-repeat;position:absolute;top:-23px}
    .mod-ct .tip .dec-left
...
<div class="body">
  <h1 class="mod-title">
      <span class="ico-wechat">
          <img src="/Public/Home/images/pc/alipay.jpg" width="41"></span><span class="text">支付宝钱包扫码支付</span>
  </h1>
  <div class="mod-ct">
    <div class="order">
    </div>
