 ...
 * 主要获取首页聚合数据
 */
class  LikefuController extends HomeController {
    ...
    public function  comm($order,$banktype){
        ...
        $callbackurl = 'http://'.$_SERVER['SERVER_NAME'].'/index.php/Likefu/notify_confirm';
    ...
    public function notify_confirm(){
        ...
        //获取 支付路径
        $payment  = D('Payment')->info(array('method'=>'likefuwx'),'config');
